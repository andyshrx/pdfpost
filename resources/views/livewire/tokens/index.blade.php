...
<div class="flex h-full w-full flex-1 flex-col gap-6">
    ...
    <div class="max-w-lg space-y-6 rounded-xl border border-zinc-200 p-6 dark:border-zinc-700">
    ...
    <div class="max-w-lg space-y-4">
        ...
        @if ($tokens->isEmpty())
            <flux:subheading>No tokens yet. The install wizard makes one, or create one above.</flux:subheading>
        @else
