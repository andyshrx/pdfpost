...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
            ...
            <flux:navbar class="mr-1.5 space-x-0.5 py-0!">
                ...
                <flux:tooltip content="Repository" position="bottom">
                    <flux:navbar.item
                        ...
                        icon="folder-git-2"
                        href="https://github.com/andyshrx/pdfpost"
                        target="_blank"
                        label="Repository"
                    />
                </flux:tooltip>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="folder-git-2" href="https://github.com/andyshrx/pdfpost" target="_blank">
                    Repository
                </flux:navlist.item>

                <flux:navlist.item icon="book-open-text" href="https://pdfpost.dev" target="_blank">
                    Documentation
                </flux:navlist.item>
            </flux:navlist>
        </flux:sidebar>
